			...
			<div class="row">
                ...
                <div class="col-sm-12">
					<div class="form-group">
						...
						<input disabled name="meta_title" type="text" class="form-control input" max="200">
					</div>
				</div>
                <div class="col-sm-12">
					<div class="form-group">
						<label>Meta Content</label>
						<input disabled name="meta_content" type="text" class="form-control input" max="200">
					</div>
				</div>
                <div class="col-sm-12">
					<div class="form-group">
						<label>Meta Keyword</label>
						<input disabled name="meta_keyword" type="text" class="form-control input" max="200">
					</div>
				</div>
			</div>
		</div>
